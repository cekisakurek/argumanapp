//
//  PremiseDetailsViewController.m
//  Arguman
//
...
@interface PremiseDetailsViewController () <UITableViewDelegate,UITableViewDataSource>
@property (strong) UITableView *tableView;
@property (strong) PremiseTableHeaderView *headerView;
@property (strong) PremiseCell *heightCalculaterCell;

@end

@implementation PremiseDetailsViewController
...
- (void)loadView
{
    ...
    self.headerView = [[PremiseTableHeaderView alloc] initWithFrame:CGRectMake(0, 0, self.tableView.bounds.size.width, 100)];
...
- (void)viewDidLoad {
    ...
    self.headerView.premise = self.premise;
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return self.premise.childPremises.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    Premise *premise = self.premise.childPremises[indexPath.row];
